...
import type { ListSandboxesQuery } from './Sandbox.js';
...
export declare class Daytona implements AsyncDisposable {
    ...
    readonly warmPool: WarmPoolService;
    /**
     ...
     */
    _experimental_fork(sandbox: Sandbox, params?: ForkSandboxParams, timeout?: number): Promise<Sandbox>;
    /**
     * Deletes a Sandbox.
     *
     ...
     * @hidden
     */
    static createAxiosInstance(requestTimeoutMs?: number): AxiosInstance;
}
