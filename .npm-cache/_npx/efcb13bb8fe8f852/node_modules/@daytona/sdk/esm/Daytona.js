...
import { Configuration, SnapshotsApi, ObjectStorageApi, SandboxApi, SandboxState, SecretApi, VolumesApi, WarmPoolsApi, ConfigApi, } from '@daytona/api-client';
import axios, { AxiosError } from 'axios';
import { DaytonaAuthenticationError, createAxiosDaytonaError, DaytonaError, DaytonaInvalidArgumentError, DaytonaTimeoutError, } from './errors/DaytonaError.js';
import { Image } from './Image.js';
import { Sandbox } from './Sandbox.js';
import { SecretService } from './Secret.js';
import { SnapshotService } from './Snapshot.js';
import { VolumeService } from './Volume.js';
import { WarmPoolService } from './WarmPool.js';
import { getPackageInfo, dynamicRequire } from './utils/Import.js';
...
let Daytona = (() => {
    ...
    return class Daytona {
        static {
            ...
            _fork_decorators = [WithInstrumentation()];
        ...
        constructor(config) {
            ...
            if (!useDeprecatedPolling) {
                this.eventDispatcher = new EventDispatcher(this.apiUrl, this.apiKey || this.jwtToken, this.organizationId, sdkLabel, packageJson.version);
        ...
        async create(params, options = { timeout: 60 }) {
            ...
            if (params.language) {
                ...
                if (!validLanguages.includes(params.language)) {
                    throw new DaytonaInvalidArgumentError(`Invalid ${CODE_TOOLBOX_LANGUAGE_LABEL}: ${params.language}. Supported languages: ${validLanguages.join(', ')}`);
                }
            ...
            if (params.autoStopInterval && params.autoPauseInterval) {
                throw new DaytonaInvalidArgumentError('autoStopInterval and autoPauseInterval are mutually exclusive. Set at most one of them to a non-zero value');
            }
            if (params.autoPauseInterval && (params.ephemeral || params.autoDeleteInterval === 0)) {
                throw new DaytonaInvalidArgumentError('Ephemeral sandboxes cannot have auto-pause enabled. Set autoPauseInterval to 0');
            }
            if (params.ephemeral) {
            ...
            try {
                ...
                const sandbox = new Sandbox(await this.ensureToolboxProxyUrl(sandboxInstance), new Configuration(structuredClone(this.clientConfig)), Daytona.createAxiosInstance(this.requestTimeoutMs), this.sandboxApi, this.getAnalyticsApiUrl, this.eventSubscriptionManager, this.requestTimeoutMs);
        ...
        async get(sandboxIdOrName) {
            ...
            return new Sandbox(sandboxInstance, structuredClone(this.clientConfig), Daytona.createAxiosInstance(this.requestTimeoutMs), this.sandboxApi, this.getAnalyticsApiUrl, this.eventSubscriptionManager, this.requestTimeoutMs);
        }
        /**
            ...
            async function* generator() {
                ...
                while (true) {
                    ...
                    for (const sandbox of response.data.items) {
                        ...
                        yield new Sandbox(hydratedSandbox, structuredClone(clientConfig), Daytona.createAxiosInstance(requestTimeoutMs), sandboxApi, getAnalyticsApiUrl, eventSubscriptionManager, requestTimeoutMs);
                    }
