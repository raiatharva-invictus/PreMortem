...
export type RegisteredPassthroughEvent = {
    [K in keyof AgentPassthroughEventSchemaMap]: AgentPassthroughEventSchemaMap[K] extends z.ZodType<infer Event> ? Event & {
        type: K;
 ...
 */
export type WithRegisteredPassthrough<T> = [RegisteredPassthroughEvent] extends [never] ? T : T | RegisteredPassthroughEvent;
//# sourceMappingURL=PassthroughEvents.d.ts.map