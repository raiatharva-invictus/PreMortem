// src/db/postgres/migrations/20260810_000001_agent.ts
import { sql } from "kysely";
async function up(db) {
  await sql`SET LOCAL lock_timeout = '5s'`.execute(db);
  await db.schema.createTable("agent").addColumn("id", "text", (col) => col.notNull()).addColumn("tenant_id", "text", (col) => col.notNull()).addColumn("name", "text", (col) => col.notNull()).addColumn("manifest", "jsonb", (col) => col.notNull()).addColumn("created_at", "timestamptz", (col) => col.notNull()).addColumn("updated_at", "timestamptz", (col) => col.notNull()).addPrimaryKeyConstraint("agent_pkey", ["id"]).execute();
...
//# sourceMappingURL=20260810_000001_agent.js.map