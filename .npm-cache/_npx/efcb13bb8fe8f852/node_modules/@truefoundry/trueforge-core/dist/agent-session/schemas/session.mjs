...
var SessionAgentReferenceSchema = z.object({
  ...
  name: z.string().nullable().describe("Create-time snapshot of the registry agent name; null for legacy or orphan rows.")
}).strict().openapi("SessionAgentReference");
var SessionAgentInlineSchema = z.object({
