...
export declare class McpServersClient {
     ...
     */
    authorize(name: string, request?: TrueForge.AuthorizeMcpServersRequest, requestOptions?: McpServersClient.RequestOptions): core.HttpResponsePromise<TrueForge.McpAuthStatus>;
    private __authorize;
    /**
     ...
     */
    listTools(name: string, requestOptions?: McpServersClient.RequestOptions): core.HttpResponsePromise<TrueForge.ListMcpServerToolsResponse>;
    private __listTools;
}
