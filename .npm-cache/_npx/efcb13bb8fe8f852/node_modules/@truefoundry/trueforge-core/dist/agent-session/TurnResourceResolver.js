...
// src/agent-session/TurnResourceResolver.ts
var TurnResourceResolver_exports = {};
__export(TurnResourceResolver_exports, {
  TurnResourceResolver: () => TurnResourceResolver
});
module.exports = __toCommonJS(TurnResourceResolver_exports);
var import_RemoteMCP = require("../core/mcp/RemoteMCP.js");
var import_ToolSet = require("../core/mcp/ToolSet.js");
var import_NoopAgentTracing = require("../core/tracing/NoopAgentTracing.js");
function specWantsSandbox(spec) {
...
var TurnResourceResolver = class {
  constructor(deps) {
    this.deps = deps;
  }
  deps;
  ...
  async resolveAgentDefinition(input) {
      ...
      (spec.mcp_servers ?? []).map(async (entry) => {
        const source = await this.getOrCreateToolSource({
          ...
          create: async () => {
            ...
            return new import_RemoteMCP.RemoteMCP({
              id: entry.name,
              name: entry.name,
              url,
              headers: headers ?? {},
        ...
        return new import_ToolSet.ToolSet({
          source,
    ...
    return {
      definition: {
        ...
        instruction: agentInfo ? void 0 : spec.instructions,
        messages: agentInfo ? [{ role: "user", content: agentInfo.input }] : spec.messages?.map((m) => ({ role: "user", content: m.content })),
        modelParams: {
        ...
        responseFormat: agentInfo ? void 0 : spec.response_format,
...
//# sourceMappingURL=TurnResourceResolver.js.map