...
function getGatewayRealtimeAuthToken(secWebSocketProtocol) {
  var _a12;
  return ((_a12 = findProtocol(secWebSocketProtocol, GATEWAY_AUTH_SUBPROTOCOL_PREFIX)) == null ? void 0 : _a12.slice(
    GATEWAY_AUTH_SUBPROTOCOL_PREFIX.length
  )) || void 0;
}
function getGatewayRealtimeTeamIdOrSlug(secWebSocketProtocol) {
  var _a12;
  const encoded = (_a12 = findProtocol(
    secWebSocketProtocol,
    GATEWAY_TEAM_SUBPROTOCOL_PREFIX
  )) == null ? void 0 : _a12.slice(GATEWAY_TEAM_SUBPROTOCOL_PREFIX.length);
...
import {
  createJsonErrorResponseHandler as createJsonErrorResponseHandler12,
  createJsonResponseHandler as createJsonResponseHandler12,
  getErrorMessage as getErrorMessage12,
  loadOptionalSetting,
  postJsonToApi as postJsonToApi9,
    ...
    try {
      ...
      const { value } = await getFromApi2({
        ...
        failedResponseHandler: createJsonErrorResponseHandler2({
          ...
          errorToMessage: (data) => {
            var _a12;
            return (_a12 = getErrorMessage2(data)) != null ? _a12 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      ...
      const { value } = await getFromApi3({
        ...
        failedResponseHandler: createJsonErrorResponseHandler3({
          ...
          errorToMessage: (data) => {
            var _a12;
            return (_a12 = getErrorMessage3(data)) != null ? _a12 : "unknown error";
          }
        }),
        fetch: this.config.fetch
      });
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler4({
          ...
          errorToMessage: (data) => {
            var _a12;
            return (_a12 = getErrorMessage4(data)) != null ? _a12 : "unknown error";
          }
        }),
...
var GatewayBatchLanguageModel = class _GatewayBatchLanguageModel extends GatewayLanguageModel {
  static [WORKFLOW_SERIALIZE2](model) {
    return GatewayLanguageModel[WORKFLOW_SERIALIZE2](model);
  }
  ...
  async experimental_doStartBatch({
    ...
    try {
      const { value: responseBody } = await postJsonToApi2({
        ...
        failedResponseHandler: createJsonErrorResponseHandler5({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage5(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
...
var gatewayBatchProviderMetadataSchema = z.record(
  z.string(),
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler6({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage6(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
    ...
    try {
      const { responseHeaders, value: responseBody } = await postJsonToApi4({
        ...
        failedResponseHandler: createJsonErrorResponseHandler7({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage7(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
...
var GatewayVideoModel = class {
  ...
  async doGenerate(options) {
    ...
    try {
      const { responseHeaders, value: responseBody } = await postJsonToApi5({
        url: this.getUrl(),
        ...
        failedResponseHandler: createJsonErrorResponseHandler8({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage8(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler9({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage9(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
    ...
    try {
      const {
        ...
        failedResponseHandler: createJsonErrorResponseHandler10({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage10(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
...
var GatewayTranscriptionModel = class {
  ...
  async doGenerate({
    ...
    var _a12, _b12, _c, _d;
    const resolvedHeaders = this.config.headers ? await resolve11(this.config.headers) : void 0;
    try {
      const {
        responseHeaders,
        value: responseBody,
        ...
        url: this.getUrl(),
        headers: combineHeaders8(
          resolvedHeaders,
          headers != null ? headers : {},
          this.getModelConfigHeaders(),
          await resolve11(this.config.o11yHeaders)
        ),
        body: {
        ...
        failedResponseHandler: createJsonErrorResponseHandler11({
          ...
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage11(data)) != null ? _a13 : "unknown error";
          }
        }),
        ...abortSignal && { abortSignal },
        fetch: this.config.fetch
  ...
  async doStream(options) {
    ...
    const headers = combineHeaders8(
      await resolve11((_d = this.config.headers) != null ? _d : {}),
...
function getServerErrorMessage(error) {
  ...
  return getErrorMessage11(error);
}
...
var takoSearchInputSchema = lazySchema13(
  () => zodSchema13(
    z.object({
...
var takoSearchToolFactory = createProviderExecutedToolFactory4({
...
async function getVercelRequestId() {
  var _a12;
  return (_a12 = getContext().headers) == null ? void 0 : _a12["x-vercel-id"];
}
...
function createGateway(options = {}) {
  ...
  const mintClientSecret = async (params) => {
    ...
    try {
      const { value } = await postJsonToApi9({
        url,
        headers,
        body: {
        ...
        successfulResponseHandler: createJsonResponseHandler12(
          gatewayClientSecretResponseSchema
        ),
        failedResponseHandler: createJsonErrorResponseHandler12({
          errorSchema: z.any(),
          errorToMessage: (data) => {
            var _a13;
            return (_a13 = getErrorMessage12(data)) != null ? _a13 : "unknown error";
          }
        }),
        fetch: options.fetch
      });
