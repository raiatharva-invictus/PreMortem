...
declare class StreamProviderError extends AISDKError {
    ...
    constructor({ message, type, code, statusCode, isRetryable, data, cause, }: {
        message: string;
        type?: string;
        code?: string | number;
        statusCode?: number;
...
interface StartVideoResult {
     ...
     */
    readonly operation: JSONValue$1;
    /**
     * Warnings for the call, e.g. unsupported settings.
     */
    readonly warnings: Array<Warning>;
 ...
 * metadata.
 */
declare function experimental_startVideo({ model: modelArg, prompt: promptArg, n, maxVideosPerCall, aspectRatio, resolution, duration, fps, seed, frameImages, inputReferences, generateAudio, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers, webhookUrl, }: {
    model: VideoModel;
    prompt: GenerateVideoPrompt;
    n?: number;
    maxVideosPerCall?: number;
 ...
 */
type GetVideoStatusResult = Experimental_VideoModelV4OperationStatusResult;
/**
 ...
 */
declare function experimental_getVideoStatus(modelArg: VideoModel, { operation, headers, abortSignal, maxRetries: maxRetriesArg, }: {
    operation: JSONValue$1;
    headers?: Record<string, string>;
    abortSignal?: AbortSignal;
    maxRetries?: number;
