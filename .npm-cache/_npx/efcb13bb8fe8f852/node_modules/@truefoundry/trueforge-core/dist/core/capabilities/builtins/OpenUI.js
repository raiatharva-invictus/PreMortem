...
// src/core/capabilities/builtins/OpenUI.ts
var OpenUI_exports = {};
__export(OpenUI_exports, {
  GET_OPENUI_INSTRUCTIONS_TOOL_NAME: () => GET_OPENUI_INSTRUCTIONS_TOOL_NAME,
  OPENUI_BUILTIN_FUNCTIONS_TAG: () => OPENUI_BUILTIN_FUNCTIONS_TAG,
  OPENUI_COMPONENT_SIGNATURES_TAG: () => OPENUI_COMPONENT_SIGNATURES_TAG,
  OPENUI_EXAMPLES_TAG: () => OPENUI_EXAMPLES_TAG,
  OPENUI_FINAL_VERIFICATION_TAG: () => OPENUI_FINAL_VERIFICATION_TAG,
  OPENUI_HOISTING_AND_STREAMING_TAG: () => OPENUI_HOISTING_AND_STREAMING_TAG,
  OPENUI_IMPORTANT_RULES_TAG: () => OPENUI_IMPORTANT_RULES_TAG,
  OPENUI_MARKDOWN_FENCING_TAG: () => OPENUI_MARKDOWN_FENCING_TAG,
  OPENUI_SECTION_TAG: () => OPENUI_SECTION_TAG,
  OPENUI_SERVER_ID: () => OPENUI_SERVER_ID,
  OPENUI_SYNTAX_RULES_TAG: () => OPENUI_SYNTAX_RULES_TAG,
  OPENUI_USER_INTERACTION_CHECKLIST_TAG: () => OPENUI_USER_INTERACTION_CHECKLIST_TAG,
  OpenUIInstructions: () => OpenUIInstructions,
  buildOpenUIInstruction: () => buildOpenUIInstruction,
  openUI: () => openUI,
  renderOpenUIPrompt: () => renderOpenUIPrompt
});
module.exports = __toCommonJS(OpenUI_exports);
...
var import_NoopAgentTracing = require("../../tracing/NoopAgentTracing.js");
var OPENUI_SERVER_ID = "openui";
var GET_OPENUI_INSTRUCTIONS_TOOL_NAME = "get_openui_instructions";
var getOpenUIInstructionsInputSchema = import_zod.z.object({}).strict();
var OPENUI_SECTION_TAG = "openui";
var OPENUI_MARKDOWN_FENCING_TAG = "openui-markdown-fencing";
var OPENUI_SYNTAX_RULES_TAG = "openui-syntax-rules";
var OPENUI_COMPONENT_SIGNATURES_TAG = "openui-component-signatures";
var OPENUI_BUILTIN_FUNCTIONS_TAG = "openui-builtin-functions";
var OPENUI_HOISTING_AND_STREAMING_TAG = "openui-hoisting-and-streaming";
var OPENUI_EXAMPLES_TAG = "openui-examples";
var OPENUI_IMPORTANT_RULES_TAG = "openui-important-rules";
var OPENUI_FINAL_VERIFICATION_TAG = "openui-final-verification";
var OPENUI_USER_INTERACTION_CHECKLIST_TAG = "openui-user-interaction-checklist";
function buildOpenUIInstruction(builder) {
...
function renderOpenUIPrompt() {
  const root = new import_InstructionBuilder.InstructionBuilder("_openui_render");
...
function buildOpenUIDeferredInstruction(builder) {
  builder.addSection(
    OPENUI_SECTION_TAG,
    import_dedent.default`
...
var OpenUIInstructions = class extends import_LocalToolMCP.LocalToolMCP {
  name = OPENUI_SERVER_ID;
  displayName = "OpenUI";
  constructor(tracing) {
    super({ tracing });
  }
  tools = [
    (0, import_LocalToolMCP.defineTool)({
      ...
      handler: () => Promise.resolve((0, import_IMCPServer.toolResultResponse)({ text: renderOpenUIPrompt() }))
    })
  ];
  getTools() {
    return this.tools;
...
function openUI(options) {
  ...
  return {
    systemToolSets: [new OpenUIInstructions(options?.tracing ?? import_NoopAgentTracing.NOOP_AGENT_TRACING)],
