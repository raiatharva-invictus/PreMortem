...
export declare class SessionsClient {
     ...
     */
    list(request?: TrueForge.ListSessionsRequest, requestOptions?: SessionsClient.RequestOptions): Promise<core.Page<TrueForge.Session, TrueForge.ListSessionsResponse>>;
    /**
     ...
     *     })
     */
    create(request: TrueForge.CreateSessionRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.GetSessionResponse>;
    private __create;
    /**
     ...
     */
    get(session_id: string, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.GetSessionResponse>;
    private __get;
    /**
     ...
     */
    delete(session_id: string, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
    /**
     ...
     */
    update(session_id: string, request?: TrueForge.UpdateSessionRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.GetSessionResponse>;
    private __update;
    /**
     ...
     */
    cancel(session_id: string, request?: TrueForge.CancelSessionRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.CancelSessionResponse>;
    private __cancel;
    /**
     ...
     */
    listEvents(session_id: string, request?: TrueForge.ListEventsSessionsRequest, requestOptions?: SessionsClient.RequestOptions): Promise<core.Page<TrueForge.SessionEventItem, TrueForge.ListSessionEventsResponse>>;
    /**
     ...
     */
    listTurns(session_id: string, request?: TrueForge.ListTurnsSessionsRequest, requestOptions?: SessionsClient.RequestOptions): Promise<core.Page<TrueForge.Turn, TrueForge.ListTurnsResponse>>;
    /**
     ...
     */
    createTurnStream(session_id: string, request: TrueForge.CreateTurnSessionsStreamRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<core.Stream<TrueForge.TurnStreamingEvent>>;
    private __createTurnStream;
    /**
     * Create a turn within a session and execute it.
     * Only the session creator (`created_by`) may create turns.
     * When `stream` is true (default), respond with a Server-Sent Events stream of turn events.
     ...
     */
    createTurn(session_id: string, request: TrueForge.CreateTurnSessionsRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.GetTurnResponse>;
    private __createTurn;
    /**
     ...
     */
    getTurn(session_id: string, turn_id: string, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<TrueForge.GetTurnResponse>;
    private __getTurn;
    /**
     ...
     * @throws {@link errors.TrueForgeTimeoutError}
     */
    downloadSandboxFile(session_id: string, turn_id: string, request: TrueForge.DownloadSandboxFileSessionsRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<core.BinaryResponse>;
    private __downloadSandboxFile;
    /**
     ...
     */
    listTurnEvents(session_id: string, turn_id: string, request?: TrueForge.ListTurnEventsSessionsRequest, requestOptions?: SessionsClient.RequestOptions): Promise<core.Page<TrueForge.SessionEvent, TrueForge.ListTurnEventsResponse>>;
    /**
     ...
     */
    subscribeToTurn(session_id: string, turn_id: string, request?: TrueForge.SubscribeToTurnSessionsRequest, requestOptions?: SessionsClient.RequestOptions): core.HttpResponsePromise<core.Stream<TrueForge.TurnStreamingEvent>>;
    private __subscribeToTurn;
}
