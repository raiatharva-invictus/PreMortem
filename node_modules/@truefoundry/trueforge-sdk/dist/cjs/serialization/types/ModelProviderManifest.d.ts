...
export declare const ModelProviderManifest: core.serialization.Schema<serializers.ModelProviderManifest.Raw, TrueForge.ModelProviderManifest>;
export declare namespace ModelProviderManifest {
    type Raw = AlibabaModelProvider.Raw | AnthropicModelProvider.Raw | CustomModelProvider.Raw | FireworksModelProvider.Raw | GoogleGeminiModelProvider.Raw | MoonshotModelProvider.Raw | OpenAiModelProvider.Raw | TogetherAiModelProvider.Raw | ZaiModelProvider.Raw;
}
