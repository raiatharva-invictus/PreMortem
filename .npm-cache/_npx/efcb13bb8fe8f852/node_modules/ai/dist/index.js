...
import { AISDKError as AISDKError17, getErrorMessage as getErrorMessage2 } from "@ai-sdk/provider";
var name17 = "AI_ToolCallRepairError";
var marker17 = `vercel.ai.error.${name17}`;
var symbol17 = Symbol.for(marker17);
var _a17;
var ToolCallRepairError = class extends AISDKError17 {
  constructor({
    cause,
    originalError,
  ...
  static isInstance(error) {
    return AISDKError17.hasMarker(error, marker17);
  }
};
_a17 = symbol17;
...
var _a18;
var UIMessageStreamError = class extends AISDKError19 {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a19;
var InvalidDataContentError = class extends AISDKError20 {
  constructor({
    content,
    cause,
...
var _a20;
var InvalidMessageRoleError = class extends AISDKError21 {
  constructor({
    role,
...
var _a21;
var MessageConversionError = class extends AISDKError22 {
  constructor({
    originalMessage,
    message
  }) {
...
var _a22;
var RetryError = class extends AISDKError23 {
  constructor({
    message,
    reason,
    errors
...
function resolveTranscriptionModel(model) {
  var _a24, _b;
  if (typeof model === "string") {
    return (_b = (_a24 = getGlobalProvider()).transcriptionModel) == null ? void 0 : _b.call(_a24, model);
  }
  if (!["v4", "v3", "v2"].includes(model.specificationVersion)) {
    const unsupportedModel = model;
    throw new UnsupportedModelVersionError({
...
function resolveSpeechModel(model) {
  var _a24, _b;
  if (typeof model === "string") {
    return (_b = (_a24 = getGlobalProvider()).speechModel) == null ? void 0 : _b.call(_a24, model);
  }
  if (!["v4", "v3", "v2"].includes(model.specificationVersion)) {
    const unsupportedModel = model;
    throw new UnsupportedModelVersionError({
...
function getToolTimeoutMs(timeout, toolName) {
  ...
  return (_b = (_a24 = timeout.tools) == null ? void 0 : _a24[`${toolName}Ms`]) != null ? _b : timeout.toolMs;
}
...
function addLanguageModelUsage(usage1, usage2) {
  var _a24, _b, _c, _d, _e, _f, _g, _h, _i, _j;
  return {
...
function now() {
  var _a24, _b;
  return (_b = (_a24 = globalThis == null ? void 0 : globalThis.performance) == null ? void 0 : _a24.now()) != null ? _b : Date.now();
}
...
function prepareStepCallSettings({
  ...
  var _a24, _b, _c, _d, _e, _f, _g, _h, _i;
...
function hasToolCall(...toolName) {
  return ({ steps }) => {
    var _a24, _b, _c;
    return (_c = (_b = (_a24 = steps[steps.length - 1]) == null ? void 0 : _a24.toolCalls) == null ? void 0 : _b.some(
      ...
      do {
        ...
        try {
          await runInTracingChannelSpan({
            ...
            execute: async () => {
              var _a26, _b2, _c2, _d2, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
              ...
              currentModelResponse = await retry(async () => {
                var _a27, _b3, _c3, _d3, _e2, _f2, _g2, _h2;
                ...
                const responseData = {
                  id: (_b3 = (_a27 = result.response) == null ? void 0 : _a27.id) != null ? _b3 : generateId4(),
          ...
          switch (chunk.type) {
            ...
            case "tool-approval-response": {
              ...
              toolInvocation.approval = {
                ...
                ...approval.requestReason != null ? { requestReason: approval.requestReason } : {},
...
function normalizeStreamProviderError(error) {
  var _a24, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
  ...
  const details = providerStreamError ? outer : (_c = (_b = asRecord((_a24 = asRecord(outer.response)) == null ? void 0 : _a24.error)) != null ? _b : asRecord(outer.error)) != null ? _c : outer;
        ...
        try {
          ...
          for (const toolApproval2 of invalidToolApprovals) {
            toolExecutionStepStreamController == null ? void 0 : toolExecutionStepStreamController.enqueue({
              ...
              toolName: toolApproval2.toolCall.toolName,
              input: toolApproval2.toolCall.input,
              error: getErrorMessage6(toolApproval2.error),
        ...
        try {
          ...
          self.addStream(
            streamWithToolResults.pipeThrough(
              new TransformStream({
                async transform(chunk, controller) {
                  var _a26, _b2, _c2, _d2, _e2, _f2, _g2;
...
function createUIMessageStream({
  ...
  onEnd,
  onFinish,
  generateId: generateId4 = generateIdFunc
}) {
  let controller;
...
async function generateObject(options) {
  ...
  try {
    ...
    const responseData = {
      id: (_b = (_a24 = generateResult.response) == null ? void 0 : _a24.id) != null ? _b : generateId4(),
...
function streamObject(options) {
  const {
    ...
    onFinish,
    _internal: {
      generateId: generateId4 = originalGenerateId5,
      currentDate = () => /* @__PURE__ */ new Date(),
      now: now2 = now
    } = {},
    ...settings
...
function normalizeVideoCallInputs({
  promptArg,
  frameImages,
  inputReferences
}) {
...
// src/generate-video/start-video.ts
import {
  generateId as generateId2,
  withUserAgentSuffix as withUserAgentSuffix11
} from "@ai-sdk/provider-utils";
async function experimental_startVideo({
  model: modelArg,
  prompt: promptArg,
  n = 1,
  maxVideosPerCall,
  ...
  const knownMaxVideosPerCall = maxVideosPerCall != null ? maxVideosPerCall : typeof model.maxVideosPerCall === "function" ? await model.maxVideosPerCall({ modelId: model.modelId }) : model.maxVideosPerCall;
  ...
  const callerIdempotencyKey = Object.entries(headers != null ? headers : {}).find(
    ([key, value]) => key.toLowerCase() === "idempotency-key" && value !== void 0
  );
  const callOptions = {
    prompt,
    ...
    providerOptions: providerOptions != null ? providerOptions : {},
    headers: {
      ...withUserAgentSuffix11(headers != null ? headers : {}, `ai/${VERSION}`),
      ...callerIdempotencyKey ? {} : { "idempotency-key": `aisdk_vid_${generateId2()}` }
    },
    abortSignal,
    webhookUrl
  };
...
import { withUserAgentSuffix as withUserAgentSuffix12 } from "@ai-sdk/provider-utils";
async function experimental_getVideoStatus(modelArg, {
  operation,
  headers,
  abortSignal,
  maxRetries: maxRetriesArg
  ...
  return retry(
    () => model.doStatus({
      operation,
      headers: withUserAgentSuffix12(headers != null ? headers : {}, `ai/${VERSION}`),
      abortSignal
    })
  );
}
...
import {
  asArray as asArray9,
  EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL as EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL2
} from "@ai-sdk/provider-utils";
...
var BrowserRealtimeAudio = class {
  ...
  setPlaying(isPlaying) {
    ...
    if (isPlaying && !this.isPlaying) {
      this.playbackStartTime = (_b = (_a24 = this.playbackContext) == null ? void 0 : _a24.currentTime) != null ? _b : 0;
    }
...
var DefaultProviderRegistry = class {
  ...
  languageModel(id) {
    ...
    let model = (_b = (_a24 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b.call(
      _a24,
      modelId
    );
    if (model == null) {
...
function streamTranscribe({
  ...
  const headersWithUserAgent = withUserAgentSuffix14(
    headers != null ? headers : {},
    `ai/${VERSION}`
  );
  ...
  void (async () => {
    ...
    response = {
      timestamp: (_b = (_a25 = result.response) == null ? void 0 : _a25.timestamp) != null ? _b : startedAt,
...
import {
  ...
  withUserAgentSuffix as withUserAgentSuffix15
} from "@ai-sdk/provider-utils";
function streamTranslate({
  ...
  const headersWithUserAgent = withUserAgentSuffix15(
    headers != null ? headers : {},
    `ai/${VERSION}`
  );
...
import {
  ...
  withUserAgentSuffix as withUserAgentSuffix16,
...
var AbstractChat = class {
  constructor({
    generateId: generateId4 = generateIdFunc2,
    id = generateId4(),
