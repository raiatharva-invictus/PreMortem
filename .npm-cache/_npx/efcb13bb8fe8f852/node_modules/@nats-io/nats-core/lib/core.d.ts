...
export type Status = DisconnectStatus | ReconnectStatus | ReconnectingStatus | ClusterUpdateStatus | LDMStatus | ServerErrorStatus | ClientPingStatus | StaleConnectionStatus | SlowConsumerStatus | ForceReconnectStatus | CloseStatus;
export type MsgCallback<T> = (err: Error | null, msg: T) => void | Promise<never>;
/**
