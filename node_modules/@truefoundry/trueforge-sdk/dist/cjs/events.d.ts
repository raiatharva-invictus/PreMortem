 ...
 */
export declare function isEventDelta(event: {
    type: string;
}): event is TrueForge.ModelMessageDeltaEvent;
/**
 ...
 */
export declare function mergeEventDelta(base: TrueForge.TurnStreamingEvent | TrueForge.ModelMessageEvent, delta: TrueForge.ModelMessageDeltaEvent): void;
