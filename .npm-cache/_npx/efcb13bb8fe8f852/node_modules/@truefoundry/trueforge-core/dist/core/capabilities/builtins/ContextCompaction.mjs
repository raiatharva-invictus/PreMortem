// src/core/capabilities/builtins/ContextCompaction.ts
...
`;
var CONTINUATION_MESSAGE = internalSystemMessage(
...
var CONTINUATION_MESSAGE_TOKENS = 42;
...
function createSummarizationCandidate(context) {
  let candidate = "";
  let index = -1;
...
var ContextCompaction = class {
  ...
  async *processPreLLM(execution) {
    ...
    const context = [{ role: "assistant", content: response.output.content }, CONTINUATION_MESSAGE];
    yield {
