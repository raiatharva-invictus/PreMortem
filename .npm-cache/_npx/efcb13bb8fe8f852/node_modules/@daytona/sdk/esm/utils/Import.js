...
export function getPackageInfo() {
    if (_packageInfo)
        return _packageInfo;
    try {
        const pkg = {"name":"@daytona/sdk","version":"0.204.1"};
