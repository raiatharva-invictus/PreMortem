...
export interface ToolResponseProcessor {
    process(result: ToolCallResult[], execution: Readonly<AgentThreadExecutionContext>): Promise<ToolResponseProcessorResult>;
}
//# sourceMappingURL=ToolResponseProcessor.d.ts.map