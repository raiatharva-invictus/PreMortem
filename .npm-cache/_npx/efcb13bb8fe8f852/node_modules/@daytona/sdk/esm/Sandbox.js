...
import { FileSystemApi, GitApi, ProcessApi, LspApi, InfoApi, SystemApi, ComputerUseApi, InterpreterApi, ServerApi, } from '@daytona/toolbox-api-client';
...
import { buildSignedFileUrl } from './utils/fileUrlSigning.js';
...
let Sandbox = (() => {
    ...
    return class Sandbox {
        static {
            ...
            _downloadUrl_decorators = [WithInstrumentation()];
            _uploadUrl_decorators = [WithInstrumentation()];
            _rotateSigningKey_decorators = [WithInstrumentation()];
            ...
            __esDecorate(this, null, _downloadUrl_decorators, { kind: "method", name: "downloadUrl", static: false, private: false, access: { has: obj => "downloadUrl" in obj, get: obj => obj.downloadUrl }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _rotateSigningKey_decorators, { kind: "method", name: "rotateSigningKey", static: false, private: false, access: { has: obj => "rotateSigningKey" in obj, get: obj => obj.rotateSigningKey }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async downloadUrl(path, ttlSeconds) {
            return buildSignedFileUrl(this.toolboxProxyUrl, this.id, '/files/download', 'GET', path, await this.ensureSigningKey(), ttlSeconds);
        }
        /**
        ...
        async uploadUrl(path, ttlSeconds) {
            return buildSignedFileUrl(this.toolboxProxyUrl, this.id, '/files/upload-v2', 'POST', path, await this.ensureSigningKey(), ttlSeconds);
        }
        /**
