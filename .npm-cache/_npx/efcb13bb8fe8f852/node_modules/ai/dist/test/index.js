...
// src/test/mock-image-model-v4.ts
var MockImageModelV4 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    maxImagesPerCall = 1,
...
// src/test/mock-language-model-v4.ts
var MockLanguageModelV4 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    supportedUrls = {},
...
// src/test/mock-provider-v4.ts
import {
  NoSuchModelError as NoSuchModelError2
} from "@ai-sdk/provider";
var MockProviderV4 = class {
  constructor({
    languageModels,
    embeddingModels,
    imageModels,
...
// src/test/mock-speech-model-v4.ts
var MockSpeechModelV4 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    doGenerate = notImplemented
...
// src/test/mock-transcription-model-v4.ts
var MockTranscriptionModelV4 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    doGenerate = notImplemented,
...
// src/test/mock-reranking-model-v4.ts
var MockRerankingModelV4 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    doRerank = notImplemented
...
// src/test/mock-video-model-v3.ts
var MockVideoModelV3 = class {
  constructor({
    provider = "mock-provider",
    modelId = "mock-model-id",
    maxVideosPerCall = 1,
...
// src/test/mock-video-model-v4.ts
var MockVideoModelV4 = class {
  constructor(options = {}) {
    this.specificationVersion = "v4";
