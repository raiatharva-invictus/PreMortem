...
const fileUrlSigning_1 = require("./utils/fileUrlSigning");
...
let Sandbox = (() => {
    ...
    let _downloadUrl_decorators;
    let _uploadUrl_decorators;
    let _rotateSigningKey_decorators;
    ...
    return class Sandbox {
        static {
            ...
            _fork_decorators = [(0, otel_decorator_1.WithInstrumentation)(), withEvents];
            _createSnapshot_decorators = [(0, otel_decorator_1.WithInstrumentation)(), withEvents];
            ...
            _downloadUrl_decorators = [(0, otel_decorator_1.WithInstrumentation)()];
            _uploadUrl_decorators = [(0, otel_decorator_1.WithInstrumentation)()];
            _rotateSigningKey_decorators = [(0, otel_decorator_1.WithInstrumentation)()];
            ...
            tslib_1.__esDecorate(this, null, _createSnapshot_decorators, { kind: "method", name: "createSnapshot", static: false, private: false, access: { has: obj => "createSnapshot" in obj, get: obj => obj.createSnapshot }, metadata: _metadata }, null, _instanceExtraInitializers);
            tslib_1.__esDecorate(this, null, _pause_decorators, { kind: "method", name: "pause", static: false, private: false, access: { has: obj => "pause" in obj, get: obj => obj.pause }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            tslib_1.__esDecorate(this, null, _downloadUrl_decorators, { kind: "method", name: "downloadUrl", static: false, private: false, access: { has: obj => "downloadUrl" in obj, get: obj => obj.downloadUrl }, metadata: _metadata }, null, _instanceExtraInitializers);
            tslib_1.__esDecorate(this, null, _uploadUrl_decorators, { kind: "method", name: "uploadUrl", static: false, private: false, access: { has: obj => "uploadUrl" in obj, get: obj => obj.uploadUrl }, metadata: _metadata }, null, _instanceExtraInitializers);
            tslib_1.__esDecorate(this, null, _rotateSigningKey_decorators, { kind: "method", name: "rotateSigningKey", static: false, private: false, access: { has: obj => "rotateSigningKey" in obj, get: obj => obj.rotateSigningKey }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        constructor(sandboxDto, clientConfig, axiosInstance, sandboxApi, getAnalyticsApiUrl, subscriptionManager, requestTimeoutMs) {
            ...
            this.process = new Process_1.Process(this.clientConfig, new toolbox_api_client_1.ProcessApi(this.clientConfig, '', this.axiosInstance), getPreviewToken, language, this.requestTimeoutMs);
        ...
        buildAnalyticsTelemetryApi(analyticsApiUrl) {
            ...
            return new analytics_api_client_1.TelemetryApi(analyticsConfig, undefined, Daytona_1.Daytona.createAxiosInstance(this.requestTimeoutMs));
        }
        /**
        ...
        async fork(params, timeout = 60) {
            ...
            const forkedSandbox = new Sandbox(sandboxWithProxyUrl, structuredClone(this.clientConfig), Daytona_1.Daytona.createAxiosInstance(this.requestTimeoutMs), this.sandboxApi, this.getAnalyticsApiUrl, this.subscriptionManager, this.requestTimeoutMs);
            const timeElapsed = Date.now() - startTime;
        ...
        async updateNetworkSettings(settings) {
            if (settings.networkBlockAll === undefined &&
                ...
                throw new DaytonaError_1.DaytonaInvalidArgumentError('At least one of networkBlockAll, networkAllowList or domainAllowList must be set');
            }
         ...
         */
        async downloadUrl(path, ttlSeconds) {
            return (0, fileUrlSigning_1.buildSignedFileUrl)(this.toolboxProxyUrl, this.id, '/files/download', 'GET', path, await this.ensureSigningKey(), ttlSeconds);
        }
        /**
         ...
         */
        async uploadUrl(path, ttlSeconds) {
            return (0, fileUrlSigning_1.buildSignedFileUrl)(this.toolboxProxyUrl, this.id, '/files/upload-v2', 'POST', path, await this.ensureSigningKey(), ttlSeconds);
        }
        /**
        ...
        async resize(resources, timeout = 60) {
            ...
            if ('gpu' in resources || 'gpuType' in resources) {
                throw new DaytonaError_1.DaytonaInvalidArgumentError('Resize does not support changes to gpu or gpuType — to change GPU, create a new Sandbox');
            }
            const startTime = Date.now();
            const resizeRequest = {
                cpu: resources.cpu,
