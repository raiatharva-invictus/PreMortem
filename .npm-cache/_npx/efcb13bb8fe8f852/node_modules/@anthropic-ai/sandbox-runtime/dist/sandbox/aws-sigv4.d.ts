...
export declare const SIGV4A_ALGORITHM = "AWS4-ECDSA-P256-SHA256";
 ...
 */
export declare function detectSigv4(headers: IncomingHttpHeaders, requestTarget: string): Sigv4Detection | null;
 ...
 */
export declare function parseSigv4Authorization(auth: string): ParsedSigv4Authorization | null;
/**
 ...
 */
export declare function uriEncode(s: string): string;
/**
 ...
 */
export declare function canonicalUri(rawPath: string, service: string): string;
/**
 ...
 * 3986), not a space.
 */
export declare function canonicalQueryString(rawQuery: string): string;
 ...
 */
export declare function buildCanonicalRequest(input: Sigv4SignInput): string;
/** String-to-sign over a canonical request. */
export declare function buildStringToSign(canonicalRequest: string, amzDate: string, scope: {
    date: string;
    region: string;
    service: string;
}): string;
/** kSigning = HMAC-chain(AWS4+secret, date, region, service, terminator). */
export declare function deriveSigningKey(secretAccessKey: string, scope: {
    date: string;
    region: string;
    service: string;
}): Buffer;
 ...
 */
export declare function signSigv4(input: Sigv4SignInput & {
    accessKeyId: string;
    secretAccessKey: string;
}): Sigv4SignResult;
export declare function sha256Hex(data: string | Buffer): string;
/** First value of a possibly-repeated header, or undefined. */
export declare function singleHeader(v: string | string[] | undefined): string | undefined;
