...
import type { ActionRequiredEvent, AgentApprovalDecisionMessage, AgentInfo, AgentInputUserMessage, AgentOutputEvent, AgentParent, BaseMCPAuthRequiredEvent, BaseThreadDoneEvent, MCPInitializeEvent, MCPServerAuthInfo, ModelMessageDeltaEvent, ModelMessageEvent, SandboxCreatedEvent, ThreadCreatedEvent, ThreadOverwriteContextEvent, ThreadStateError, ToolApprovalRequiredEvent, ToolResponseEvent, ToolResponseRequiredEvent, UserToolApprovalMessage, UserToolResponseMessage } from '../events/schema';
...
export declare const InternalEventType: {
    readonly AGENT_CREATE_SUBAGENT: 'internal.agent.create_subagent';
    readonly AGENT_CONTEXT_APPEND: 'internal.agent.context.append';
    readonly AGENT_DONE: 'internal.agent.done';
    readonly PASSTHROUGH: 'agent.passthrough';
    readonly MCP_AUTH_REQUIRED: 'internal.mcp.auth_required';
    readonly CAPABILITY_STATE: 'internal.capability.state';
};
/**
...
export declare const InternalPassthroughEventSchema: z.ZodType<InternalPassthroughEvent>;
...
export type AgentThreadEvent = ModelMessageEvent | ModelMessageDeltaEvent | ToolResponseEvent | AgentThreadCreateSubAgent | AgentThreadAppendContext | ThreadOverwriteContextEvent | InternalThreadDoneEvent | InternalMCPAuthRequiredEvent | InternalCapabilityStateEvent | MCPInitializeEvent | SandboxCreatedEvent | ToolApprovalRequiredEvent | ToolResponseRequiredEvent | InternalPassthroughEvent;
export type AgentThreadExecutionEvent = WithRegisteredPassthrough<ThreadCreatedEvent | Exclude<AgentThreadEvent, InternalPassthroughEvent>>;
...
//# sourceMappingURL=AgentThread.types.d.ts.map